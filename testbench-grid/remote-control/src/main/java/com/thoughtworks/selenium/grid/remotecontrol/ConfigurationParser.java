...
public class ConfigurationParser {
    ...
    public static void parseConfigurationFile(OptionParser.Options options) {
        ...
        if (!configuration.exists()) {
            System.err
                    .println("No configuration file found (rc_configuration.xml).\nUsing arguments or default values.");
            return;
        }
        ...
        try {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                try {
                    ...
                    System.err
                            .println("Check configuration file <host>. Should not be left empty.");
                    System.err
                            .println("Comment it out or remove it from the configuration file.");
                }
            }
            ...
            System.err
                    .println("Error in configuration file rc_configuration.xml\nUsing arguments or default values.");
            return;
