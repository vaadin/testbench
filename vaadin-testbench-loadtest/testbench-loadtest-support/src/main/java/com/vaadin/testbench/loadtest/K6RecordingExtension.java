 ...
 *       recording proxy is active (detected via the {@code k6.proxy.host}
 *       system property).</li>
 *   <li>Ensures WebDriver cleanup after each test to prevent orphaned
 *       Chrome processes.</li>
 * </ul>
 * <p>
 * This extension uses JUnit 5's ServiceLoader auto-detection mechanism.
 * Enable it by setting:
 * <pre>
 * -Djunit.jupiter.extensions.autodetection.enabled=true
 * </pre>
 */
public class K6RecordingExtension implements ExecutionCondition, AfterEachCallback {

    private static final ConditionEvaluationResult ENABLED =
            ConditionEvaluationResult.enabled("Not in k6 recording mode or test is not @Destructive");

    private static final ConditionEvaluationResult DISABLED =
            ConditionEvaluationResult.disabled("@Destructive test skipped during k6 recording");
