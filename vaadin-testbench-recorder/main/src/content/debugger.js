...
function Debugger(editor) {
  ...
  this.init = function () {
    ...
    // TODO needed? subScriptLoader.loadSubScript('chrome://testbench-recorder/content/selenium-api-override.js', this.runner);
    if (executeUsingWebDriver) {
      subScriptLoader.loadSubScript('chrome://testbench-recorder/content/remote-selenium-commandhandlers.js', this.runner);
    } else {
    ...
    // TODO old vs. new extension mechanism
