...
Editor.prototype.loadExtensions = function () {
  ...
  // TODO comment these lines out, check that not needed
...
Editor.prototype.loadSeleniumAPI = function () {
  ...
  subScriptLoader.loadSubScript('chrome://testbench-recorder/content/selenium-core/scripts/selenium-api.js', seleniumAPI);
  subScriptLoader.loadSubScript('chrome://testbench-recorder/content/selenium-api-override.js', seleniumAPI);
  ...
  // TODO check that not needed and comment out
