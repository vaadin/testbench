...
class Karibu5BaseClassTest {

    @Nested
    class TestMethodExecutionTest extends Karibu5Test {
        @Test
        ...
        void extendingBaseClass_runTest_defaultRouteActive() {
            Assertions.assertInstanceOf(Home.class, UI.getCurrent()
    ...
    @Nested
    class DiscoverAllRoutesTest extends Karibu5Test {
        @Test
    ...
    @Nested
    class DiscoverRoutesInPackageTest extends Karibu5Test {
