...
public abstract class WebComponent
  ...
  public WebElement findElementByLinkText(String using) {
    return ((org.openqa.selenium.internal.FindsByLinkText) wrappedWebElement)
        .findElementByLinkText(using);
  }

  @Override
  public List<WebElement> findElementsByLinkText(String using) {
    return ((org.openqa.selenium.internal.FindsByLinkText) wrappedWebElement)
        .findElementsByLinkText(using);
  }
  ...
  public WebElement findElementByTagName(String using) {
    return ((org.openqa.selenium.internal.FindsByTagName) wrappedWebElement)
        .findElementByTagName(using);
  }

  @Override
  public List<WebElement> findElementsByTagName(String using) {
    return ((org.openqa.selenium.internal.FindsByTagName) wrappedWebElement)
        .findElementsByTagName(using);
  }

  @Override
  public WebElement findElementByClassName(String using) {
    return ((org.openqa.selenium.internal.FindsByClassName) wrappedWebElement)
        .findElementByClassName(using);
  }

  @Override
  public List<WebElement> findElementsByClassName(String using) {
    return ((org.openqa.selenium.internal.FindsByClassName) wrappedWebElement)
        .findElementsByClassName(using);
  }

  @Override
  public WebElement findElementByCssSelector(String using) {
    return ((org.openqa.selenium.internal.FindsByCssSelector) wrappedWebElement)
        .findElementByCssSelector(using);
  }
  ...
  public WebElement findElementByXPath(String using) {
    return ((org.openqa.selenium.internal.FindsByXPath) wrappedWebElement)
