...
The 'IT' in the test class name [classname]#AddressBookIT#, marks it as an Integration Test using the conventions of the Failsafe plugin. Which results in the test being run in the [literal]#integration-test# phase of the Maven build.
