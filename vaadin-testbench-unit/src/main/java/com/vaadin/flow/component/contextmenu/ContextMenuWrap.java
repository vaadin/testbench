...
/**
 * Test wrapper for ContextMenu components.
 *
 * @param <T>
 *            component type
 */
@Wraps(ContextMenu.class)
public class ContextMenuWrap<T extends ContextMenu> extends ComponentWrap<T> {
     ...
     *            target component
     */
    public ContextMenuWrap(T component) {
        super(component);
    }
