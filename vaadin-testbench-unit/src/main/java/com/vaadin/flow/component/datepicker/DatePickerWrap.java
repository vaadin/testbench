...
/**
 * Test wrapper for the DatePicker components.
 *
 * @param <T>
 *            component type
 */
@Wraps(DatePicker.class)
public class DatePickerWrap<T extends DatePicker> extends ComponentWrap<T> {
     ...
     *            target component
     */
    public DatePickerWrap(T component) {
        super(component);
    }
