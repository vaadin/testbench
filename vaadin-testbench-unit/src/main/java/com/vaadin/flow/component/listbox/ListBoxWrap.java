...
/**
 * Test wrapper for ListBox components.
 *
 * @param <T>
 *            component type
 * @param <V>
 *            value type
 */
@Wraps(fqn = { "com.vaadin.flow.component.listbox.ListBox" })
public class ListBoxWrap<T extends ListBox<V>, V> extends ComponentWrap<T> {
    /**
     ...
     *            target component
     */
    public ListBoxWrap(T component) {
        super(component);
    }
