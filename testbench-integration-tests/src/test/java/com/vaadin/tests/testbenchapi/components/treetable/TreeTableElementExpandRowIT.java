package com.vaadin.tests.testbenchapi.components.treetable;
...
public class TreeTableElementExpandRowIT extends MultiBrowserTest {
    ...
    private void testRowByIndex(int rowIndex, String expectedValue,
        ...
        errorMessage += "Return value of row=" + rowIndex
                + " cell=0 should be " + expectedValue + ".";
