package com.vaadin.tests.testbenchapi.components.grid;
...
import com.vaadin.testUI.GridUI;
import com.vaadin.testbench.TestBenchElement;
import com.vaadin.testbench.elements.GridElement;
import com.vaadin.testbench.elements.LabelElement;
import com.vaadin.tests.testbenchapi.MultiBrowserTest;

public class GridDetailsIT extends MultiBrowserTest {
    ...
    public void gridDetails_gridDetailsOpen_elementReturned() {
        ...
        assertEquals("Foo = foo 0 Bar = bar 0", details.$(LabelElement.class)
                .first().getText());
    }
