...
import com.vaadin.testUI.CompatibilityAbstractTextElementSetValue;
 ...
 * @author Vaadin Ltd
 */
public class CompatibilityAbstractTextElementSetValueIT extends
        MultiBrowserTest {
    ...
    public void textFieldSetValue() {
        checkType($(TextFieldElement.class).get(0), $(LabelElement.class)
                .get(1));
    }

    @Test
    public void passwordFieldSetValue() {
        checkType($(PasswordFieldElement.class).get(0), $(LabelElement.class)
                .get(2));
    }
