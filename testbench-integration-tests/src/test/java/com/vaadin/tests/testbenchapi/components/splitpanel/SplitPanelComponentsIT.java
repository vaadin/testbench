 ...
 * the License.
 */
package com.vaadin.tests.testbenchapi.components.splitpanel;
...
public class SplitPanelComponentsIT extends MultiBrowserTest {
    ...
    public void getSecondInHorizontalSplitPanel() throws Exception {
        ...
        assertTrue(
                "The second component of the split panel should be a label"
                        ...
                        + labelText, "Label 1.2".equals(labelText));
    }
    ...
    public void getSecondInVerticalSplitPanel() throws Exception {
        ...
        assertTrue(
                "The second component of the split panel should be a label"
                        + " containing the text 'Label 2.2'. Actual text: "
                        + labelText, "Label 2.2".equals(labelText));
    }
