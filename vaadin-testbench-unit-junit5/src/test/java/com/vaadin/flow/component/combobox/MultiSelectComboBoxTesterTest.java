...
import com.vaadin.flow.component.combobox.MultiSelectComboBoxView.Name;
...
public class MultiSelectComboBoxTesterTest extends UIUnitTest {
    ...
    void selectItem_selectsCorrectItem() {
        ...
        Assertions.assertTrue(test(view.combo).getSelected().contains(view.items.get(0)));
        Assertions.assertTrue(test(view.combo).getSelected().contains(view.items.get(1)));
